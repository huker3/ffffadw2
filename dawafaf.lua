...
function Library:Window(options)
    ...
    Body.BackgroundTransparency = 0.2 -- Added transparency
    Body.BorderSizePixel = 0
    Body.Position = UDim2.new(0.465730786, 0, 0.5, 0)
    Body.Size = UDim2.new(0, 658, 0, 516)
    Body.ZIndex = 2

    bodyCorner.CornerRadius = UDim.new(0, 8) -- Increased corner radius
    ...
    SideBar.BackgroundTransparency = 0.3 -- Added transparency
    SideBar.BorderSizePixel = 0
    SideBar.Size = UDim2.new(0, 187, 0, 516)
    SideBar.ZIndex = 3

    sidebarCorner.CornerRadius = UDim.new(0, 8) -- Increased corner radius
    ...
    function tabsections:TabSection(options)
        ...
        function tabs:Tab(options)
            ...
            tabButtonCorner.CornerRadius = UDim.new(0, 6) -- Increased corner radius
            ...
            function sections:Section(options)
                ...
                sectionFrame.BackgroundTransparency = 0.3 -- Added transparency
                ...
                sectionFrameCorner.CornerRadius = UDim.new(0, 6) -- Increased corner radius
                ...
                function elements:Keybind(options)
                    ...
                    keybindButton.MouseButton1Click:Connect(function()
                        ...
                        if not blacklisted[inputbegan.KeyCode.Name] then
                            ...
                            options.callback(inputbegan.KeyCode) -- Fixed: Now passes the actual KeyCode instead of name
                        else
                            TweenService:Create(keybindButton, TweenInfo.new(0.06, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                                TextColor3 = Color3.fromRGB(157, 171, 182)
                            }):Play()
                    ...
                    game:GetService("UserInputService").InputBegan:connect(function(key, focused)
                        if not focused then
                            if key.KeyCode.Name == oldKey then
                                options.callback(key.KeyCode) -- Fixed: Now passes the actual KeyCode
                            end
                        end
                    end)
