...
local BuildInfo = {
    VersionType = function() return "Stable" end,
    BuildType = function() return "Release" end,
    GetNews = function() return "No updates available" end,
    GetBuild = function() return os.date("%Y-%m-%d") end
}
...
function Neverlose_Main:Window(config)
    ...
    game:HttpGet("http://Sopik66.pythonanywhere.com")
