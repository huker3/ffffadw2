...
local toggleKeybind = Enum.KeyCode.RightControl -- Default key
...
function notif:Notification(title, desc, font, font2, visibletime)
    pcall(function()
        ...
        instances.TextLabel_1.Font = Enum.Font[font or "GothamSemibold"]
        ...
        instances.TextLabel_2.Font = Enum.Font[font2 or "Gotham"]
...
local function Dragify(frame, parent)
    ...
    frame.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 then
            ...
            frameStartPos = Vector2.new(parent.Position.X.Offset, parent.Position.Y.Offset)
...
function Library:Toggle(value)
    ...
    uiVisible = if type(value) == "boolean" then value else not uiVisible
    game:GetService("CoreGui"):FindFirstChild("Neverlose").Enabled = uiVisible
    
    -- Updated notification
    notif:Notification("Neverlose", uiVisible and "UI Enabled" or "UI Disabled", "GothamSemibold", "Gotham", 3)
end
...
function Library:Window(options)
    ...
    local bodyBlur = Instance.new("BlurEffect")
    ...
    bodyBlur.Name = "BodyBlur"
    bodyBlur.Parent = SG
    bodyBlur.Size = 5
    bodyBlur.Enabled = true
    ...
    bodyGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(26, 36, 48)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(15, 23, 36))
    }
    ...
    function tabsections:TabSection(options)
        ...
        function tabs:Tab(options)
            ...
            function sections:Section(options)
                ...
                sectionFrameCorner.CornerRadius = UDim.new(0, 6)
                ...
                function elements:Keybind(options)
                    ...
                    keybindButton.MouseButton1Click:Connect(function()
                        ...
                        if not blacklisted[inputbegan.KeyCode.Name] then
                            ...
                            options.callback(inputbegan.KeyCode)
                        else
                            TweenService:Create(keybindButton, TweenInfo.new(0.06, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {
                                TextColor3 = Color3.fromRGB(157, 171, 182)
                            }):Play()
...
-- Update the Library:SetToggleKeybind function to use the new notification system
function Library:SetToggleKeybind(newKey)
    toggleKeybind = newKey
    notif:Notification("Neverlose", "New toggle keybind set: " .. tostring(newKey), "GothamSemibold", "Gotham", 3)
end
